      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        ...
        <div className="mt-8 sm:mt-12 grid gap-8 lg:gap-12 lg:grid-cols-12 lg:items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Copy Email Card */}
            <div className="rounded-2xl sm:rounded-3xl border border-[#e4d7c5] bg-[#fdf8f1] p-4 sm:p-6 shadow-sm">
              ...
              <div className="mt-3 flex flex-col sm:flex-row sm:items-center justify-between gap-3 rounded-xl sm:rounded-2xl border border-[#ebdcca] bg-[#f7f1e8] p-3 sm:p-3.5 min-w-0">
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 rounded-xl bg-[#2e3b23] px-3.5 py-2 text-xs font-semibold text-[#f7f1e8] transition-all hover:bg-[#3f4f2d] shrink-0 w-full sm:w-auto"
                >
                  {copied ? (
                    <>
            ...
            <div className="space-y-4 rounded-2xl sm:rounded-3xl border border-[#e4d7c5] bg-[#efe3d3]/70 p-4 sm:p-6">
            ...
            <div className="pt-2">
              ...
              <div className="flex flex-wrap items-center gap-2.5 sm:gap-3">
                <a
                  ...
                  className="flex flex-1 sm:flex-initial items-center justify-center gap-2 rounded-xl sm:rounded-2xl border border-[#e4d7c5] bg-[#fdf8f1] px-4 py-2.5 sm:px-5 sm:py-3 text-xs font-bold text-[#1d1d1d] transition-all hover:bg-[#2e3b23] hover:text-white min-w-[105px]"
                >
                  <FaGithub size={16} />
                  <span>GitHub</span>
                </a>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-[#ebdcca] bg-[#f7f1e8] px-3.5 py-2.5 sm:px-4 sm:py-3 text-sm text-[#1d1d1d] outline-none transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-semibold text-[#2d2a26] mb-1.5">
